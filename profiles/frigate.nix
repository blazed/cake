...
in
{
  services.frigate = {
    ...
    settings = {
      ...
      cameras.e1_zoom = {
        ...
        zones.doorway = {
          coordinates = "0.369,0.103,0.445,0.111,0.452,0.466,0.38,0.498";
          loitering_time = 0;
          friendly_name = "Doorway";
        };
        motion.mask = [
          "0.369,0.013,0.37,0.074,0.003,0.079,0.002,0.02"
          "0.814,0.923,0.812,0.981,0.984,0.981,0.982,0.925"
        ];
      };
    };
  };
  ...
  services.tailscale.serve = {
    enable = true;
    services.frigate.endpoints."tcp:443" = "http://127.0.0.1:80";
  };
}
