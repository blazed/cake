  ...
  xsession.windowManager.i3 = {
    ...
    config = {
      ...
      startup = [
        ...
        { command = "${pkgs.unclutter-xfixes}/bin/unclutter"; always = false; notification = true; }
        { command = "${pkgs.gnupg}/bin/gpg-connect-agent updatestartuptty /bye >/dev/null"; always = false; notification = false; }
